              ...
              DMIT</motion.p> */}
                ...
                <div className='  flex justify-between flex-wrap'>
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">The process starts with the collection of fingerprints from all ten fingers. Each finger is believed to correspond to different aspects of cognitive and psychological traits.
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]"> The collected fingerprints are analyzed to identify the various patterns and ridge counts. This analysis is purportedly linked to the development of different regions of the brain.
                ...
                <div className='  flex justify-between flex-wrap'>
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">DMIT is based on the analysis of unique dermatoglyphic patterns formed during fetal development, providing a reliable and scientific insight into your brain's functionality.
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]"> Discover your dominant intelligences, such as linguistic, logical-mathematical, musical, spatial, bodily-kinesthetic, interpersonal, intrapersonal, and naturalistic intelligences, tailored specifically to your fingerprint patterns.
                        </p>
                    </div>
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">  Whether you are a student, a professional, or simply someone seeking personal growth, DMIT helps you leverage your strengths and address areas for improvement, paving the way for a well-rounded development.
                ...
                <div className='  flex justify-between flex-wrap'>
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">Gain insights into your career preferences and potential, helping you make informed decisions and excel in your chosen field.
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">Optimize your learning strategies and educational plans by understanding your natural strengths and preferred learning styles.
                    ...
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">  Support your child's development by recognizing their innate abilities and nurturing their growth in the most effective way.
                        </p>
                    </div>
                    <div className="block max-w-md p-3 mt-7 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p className="font-normal text-gray-700 dark:text-gray-300 text-[18px]">  Enhance your self-awareness and personal development by uncovering your true capabilities and areas for growth.
